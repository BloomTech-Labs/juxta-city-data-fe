...
function ExtraEditInputs({ handleSubmit, addHandleChange, userData}) {
    ...
    const inputData=[ {type:"text", name:"first_name", value:userData.first_name, placeholder:"First Name"},
    {type:"text", name:"last_name", value:userData.last_name, placeholder:"Last Name"},
    {type:"date", name:"dob", value:userData.dob, placeholder:"Birthdate"},
    {type:"text", name:"address", value:userData.address, placeholder:"Address"},
    {type:"text", name:"city", value:userData.city,  placeholder:"City"},
    {type:"number", name:"zip", value:userData.zip, placeholder:"Zip code"}];
        ...
        <div style={{ marginTop:"15px",textAlign:"center"}}>
            ...
            <div className="extra-profile">
                ...
                {inputData.map((item, index)=>(
                    <Form.Field> 
                        <input defaultValue={item.value}  type={item.type} name={item.name} placeholder={item.placeholder} aria-label={item.placeholder} onChange={addHandleChange} />
                    </Form.Field>
                 ))}
